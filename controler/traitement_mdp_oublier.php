...
if (isset($_POST['mail']) && $_POST['mail'] != NULL) {
    ...
    if ($nbr == 1) {
        // $message_content = 'Cliquez <a href="http://localhost/projet/e_commerce/mvc/index.php?page=601&token='.$token.'">ici</a> pour réinitialiser votre mot de passe.';
        $message_content = 'Cliquez <a href="http://localhost/e_commerce/mvc/index.php?page=601&token='.$token.'">ici</a> pour r&eacute;initialiser votre mot de passe.';
        $subject = 'r&eacute;initialisation de votre mot de passe';

        $headers = "From : ".$mail_site."\r\n";
        // $headers = "From: contact@etoffeenligne.fr\r\n";
