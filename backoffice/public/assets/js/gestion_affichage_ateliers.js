...
function gestionAfficher(id_atelier, afficher_atelier) {
    ...
    xmlhttp.open("POST", "controler/requete_gestion_affichage_ateliers.php", true); // il va chercher le fichier et l'ouvre
    ...
    xmlhttp.onload = function() { // peut aussi utiliser onreadystatechange ou autre chose
        ...
        let resultat = document.getElementById(id_atelier); // récupère le td contenant l'input
