...
function gestionAfficher(id_cat, afficher_categorie) {
    // création de l'objet XHLHttpRequest
    const xmlhttp = new XMLHttpRequest(); 
    
    xmlhttp.open("POST", "controler/requete_gestion_affichage_cat.php", true); // il va chercher le fichier et l'ouvre
    ...
    xmlhttp.onload = function() { // peut aussi utiliser onreadystatechange ou autre chose
        ...
        let resultat = document.getElementById(id_cat); // récupère le td contenant l'input
    ...
    data = ('afficher_categorie='+ afficher_categorie +'&id_cat='+ id_cat);
