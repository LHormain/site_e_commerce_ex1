...
&& $_GET['id'] != NULL
    ...
    $nombre_participant_max = $donnees['nombre_participant_max'];
    $prix_atelier = $donnees['prix_atelier'];
...
&& $_POST['nom_img_atelier'] != NULL
    ...
    && $_GET['id'] != NULL
        ...
        req_atelier_update($bdd,$nom_atelier,$nombre_participant_max,$prix_atelier,$duree_atelier,$id_atelier);

        $texte_page_courante = 'La modification a été enregistré';
    }
    else {
        //insert
        $donnees = req_atelier_insert($bdd,$nom_atelier,$nombre_participant_max,$prix_atelier,$duree_atelier);
