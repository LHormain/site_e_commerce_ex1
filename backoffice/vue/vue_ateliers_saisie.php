<?php
include ('controler/traitement_ateliers_saisie.php');
?>

<h3 class="mt-3"><?php echo $titre; ?> atelier</h3>
...
<div class="row">
    <form action="#" method="post" enctype="multipart/form-data" class="col-8 offset-2 text-start">
        ...
        <div class="mb-3">
          ...
          <small id="helpId4" class="form-text text-muted">Prix pour une personne en euro</small>
        </div>
        <!-- durée de l'atelier -->
        <div class="mb-3">
